...
function App() {
  ...
  return (
    ...
    <div className="App">
      <div className="menu">
        <Connect>{(account, provider) => <Add />}</Connect>
      </div>
    </div>
...
//     let _instance = getInstance();  //instance ko use kaise kar rha hai !
...
//   const handleCopyClickUint8 = () => {  //this function is for copying the code to clipboard
//     if (eamountUint8) {
