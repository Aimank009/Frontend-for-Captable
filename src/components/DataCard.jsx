...
export default function DataCard(props) {
  return (
    <>  
      {data.map((i) => (
        <div key={i.id} className={`flex h-[100px] mt-[10px] ml-[278px]  bg-[${getbackgroundColor(i.id)}]`}>
...
//     case 'Up to Date':
//       return '#C9FBD4'; //green color
//     case 'Missing Wallet':
//       return " #DE3333"; // Red color
//     case 'Claim available':
//       return "#C88913"; // Light orange color
//     default:
